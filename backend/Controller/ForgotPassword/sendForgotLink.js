...
const ForgotToken = require("../../modals/ForgotToken");
...
const sendForgotLink = async (req, res) => {
  try {
    ...
    if (isToken) {
      ...
      const resetUrl = `https://cardflex.in/api/reset/${user._id}/password/${passwordToken.token}`;
...
<body>
    <div class="container">
        ...
        <p>Thank you for reaching out to Card Flex!</p>
